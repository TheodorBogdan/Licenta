...
C\# este un limbaj de programare modern, orientat pe obiecte \c si puternic tipizat.C\# \^i\c si are r\u ada\u acinile
...
introduse versiuni noi ale bibliotecilor de care programul depinde. Aspecte din limbajul C\# care au fost influen\c tate 
...
scris in oricare limbaj suportat de platform\u a.La \^inceputurile sale, dezvoltarea web site-urilor Asp.NET
era asociat\u a cu WebForms, care datorit\u a limit\u arilor sale a fost \^inlocuit de Asp.NET MVC. 
...
JavaScript este sintactic similar cu C,Java \c si C\#, \^ins\u a similarit\u a\c tile se termina la sintax\u a.
JavaScript este un limbaj slab tipizat,ceea ce \^inseamn\u a c\u a variabilele nu au un tip specificat.
Obiectele asociaz\u a nume de propriet\u a\c ti unor valori arbitrare \c si se aseam\u an\u a mai mult
...
Hypertext Markup Language(HTML) este limbajul de marcaj standard pentru crearea paginilor web \c si aplica\c tiilor web.\footcite{wikiHTML}\^Impreun\u a cu 
