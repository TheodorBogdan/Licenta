...
Pentru c\u a am folosit EntityFramework \^in modul Database First pentru a avea mai mult control asupra arhitecturii
...
informa\c tii legate de starea serviciilor.
...
la mesaje de \^in\^ampinare a unui nou utilizator.
