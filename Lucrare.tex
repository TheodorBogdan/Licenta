...
Hypertext Markup Language(HTML) este limbajul de marcaj standard pentru creearea paginilor web \c si aplica\c tiilor web.\^Impreun\u a cu 
...
De asemena este nevoie \c si de o metod\u a pentru a ob\c tine toate serviciile, astfel \^inc\^at acestea s\u a poat\u a fi 
...
s\u a folosesc o implementare de tip abstract factory.
